...
public class UpdateEmployee extends JFrame implements ActionListener {
    ...
    JTextField tfeducation, tffname, tfaddress, tfphone, tfsalary, tfemail, tfdesignation;
        ...
        if (ae.getSource() == add) {
            ...
            try {
                ...
                String query = "update employee set fname = '" + fname + "', salary = '" + salary + "', address = '" +
                        address + "', email = '" + email + "', phone = '" + phone + "', education = '" + education + 
    ...
    public static void main(String[] args) {
        new UpdateEmployee("EMP001"); // Pass a valid employee ID
    }
}
